...
- **Wiki**: After working in a topic from some time you start to consolidate some knowledge that's unfit to keep in a notebook. You start to gain a cummulative and deeply interconected knowledge that starts to be too big for your head so you want to lay it down somewhere where you can come back to it when you need it. It's a record of the results and key
